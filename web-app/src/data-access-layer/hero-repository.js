...
module.exports = function ({ db }) {
    return {
        getAllHeroes: async function (callback) {
>>>>>>> 8e8d867c7f2f71faeae773321dc068e2bbfe17d3
            try {
...
=======
        ...
        createBuild: async function (newBuild, callback) {
            try {
                ...
                const query = `INSERT INTO builds (build_name, description, hero_id, talentTreeId_level_1, 
                    talentTreeId_level_4, talentTreeId_level_7, talentTreeId_level_10, talentTreeId_level_13, 
                    talentTreeId_level_16, talentTreeId_level_20) VALUES (?)`
                const values = [newBuild.build_name, newBuild.build_description, heroId, 
